...
public interface Partecipant {
	...
	/**
	 * It removes the card to avoid calculating the probability that it is in the participant's hand.
	 * it is called after a card has been played.
